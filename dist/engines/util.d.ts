...
import { IClique, ICliqueFactors, IGraph } from '..';
import { FastNode } from './FastNode';
import { FastClique } from './FastClique';
import { ICptWithoutParents, ICptWithParents } from '../types';
import { Distribution } from './Distribution';
export declare function commaSep(strings: string[]): string;
export declare function setDistribution(distribution: Distribution, nodes: FastNode[], potentials: (FastPotential | null)[]): NodeId;
 ...
 * inference engine.
 */
export declare const getNetworkInfo: (network: {
    [name: string]: {
        levels: string[];
        parents: string[];
    };
...
export declare function initializeNodes(network: {
    [name: string]: {
        levels: string[];
        parents: string[];
    };
...
export declare function initializePriorNodePotentials(network: {
    [name: string]: {
        levels: string[];
        parents: string[];
...
}, potentials: FastPotential[], fastNodes: FastNode[]): void;
